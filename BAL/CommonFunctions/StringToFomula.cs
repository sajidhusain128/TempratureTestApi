...
namespace BAL.CommonFunctions
{
    /// <summary>
    /// Static Class for convert mathematical string formula to actual
    /// </summary>
    public static class StringToFormula
    {
        ...
        /// <summary>
        /// Convert and calculate mathematical string formula to actual formula and return actual value.  
        /// </summary>
